...
const AvisoPrevioCalculator = () => {
  ...
  const calcular = () => {
    ...
    const anosCompletos = Math.max(0, Math.floor((desligamento.getTime() - admissao.getTime()) / (365.25 * MS)));
    const diasAviso = Math.min(90, 30 + 3 * Math.max(0, anosCompletos - 1));
    const valorIndenizacao = modo === "Indenizado" ? (salario / 30) * diasAviso : 0;
    
    return {
      salario: formatBRL(salario),
      anosCompletos,
      diasAviso,
      valorIndenizacao: formatBRL(valorIndenizacao),
      modo,
      observacoes: modo === "Trabalhado" 
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button
              onClick={() => {}}
              disabled={!salario || salario <= 0 || !dataAdmissao || !dataDesligamento}
              className="flex-1"
            >
        ...
        <div className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card className={resultado.modo === "Indenizado" ? "border-primary/20 bg-primary/5" : ""}>
              ...
              <CardContent>
                <div className={`text-2xl font-bold ${resultado.modo === "Indenizado" ? "text-primary" : "text-muted-foreground"}`}>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Calculado em anos completos: {resultado.anosCompletos} anos</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">30 dias + 3 dias por ano (a partir do 2º ano) = {resultado.diasAviso} dias</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
