  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white border-0 hover:scale-[1.02] shadow-elevated hover:shadow-lg transition-all duration-medium font-semibold",
      ...
      size: {
        ...
        xl: "h-14 rounded-md px-6 text-lg min-h-[48px] touch-manipulation", // Mobile-optimized
        icon: "h-10 w-10",
        "mobile-touch": "min-h-[48px] h-12 px-6 py-3 touch-manipulation", // Specific mobile touch target
      },
    },
    defaultVariants: {
      variant: "default",
