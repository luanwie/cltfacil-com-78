  ...
  const faqItems = [
    {
      ...
      answer: "Trabalhadores expostos a atividades perigosas como explosivos, inflamáveis, energia elétrica e roubos em bancos/postos. Lista completa na NR-16."
    },
    {
      question: "Posso receber periculosidade e insalubridade juntos?",
      answer: "Não, a CLT veda o acúmulo. O trabalhador deve escolher o adicional mais vantajoso, que geralmente é a periculosidade (30%)."
    },
    {
      question: "A periculosidade integra o salário para outros cálculos?",
      answer: "Sim, a periculosidade integra o salário para cálculo de férias, 13º, FGTS, horas extras e outros direitos trabalhistas."
    }
  ];

  useSEO({
    title: "Periculosidade (30%) | CLT Fácil",
    description: "Calcule o adicional de periculosidade de 30% sobre o salário. Ferramenta para atividades perigosas conforme NR-16.",
      ...
      <Container className="py-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Notice variant="warning">
            Direito ao adicional deve ser comprovado por laudo técnico. Consulte a NR-16 para lista completa de atividades perigosas.
          </Notice>
