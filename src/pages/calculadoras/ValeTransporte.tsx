  ...
  const faqItems = [
    {
      ...
      answer: "O empregado contribui com no máximo 6% do seu salário para o vale-transporte. Se o custo for maior, a empresa arca com a diferença."
    },
    {
      question: "O vale-transporte é obrigatório?",
      answer: "O empregador deve oferecer, mas o empregado pode optar por não receber se declarar por escrito que não usa transporte público."
    },
    {
      question: "Como calcular o custo mensal do VT?",
      answer: "Multiplique o preço da condução pelo número de viagens diárias e pelos dias úteis do mês (ida + volta = 2 viagens)."
    }
  ];

  useSEO({
    title: "Vale-Transporte (6%) | CLT Fácil",
    description: "Calcule desconto e custo do vale-transporte. Ferramenta para cálculo do limite de 6% e divisão empresa/empregado.",
